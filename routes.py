...
def ranking():
    ...
    return render_template("ranking.html",
        ...
        pnames=PNAMES, pcolors=PCOLORS, is_guest=False)
...
def stats():
    ...
    if not current_user.is_authenticated:
        return render_template("stats.html",
            stats=None, all_serials=[], top_by_time=[],
            genre_counts={}, fun_facts=[], all_titles=[],
            is_pro=False, is_guest=True,
            week_activity=[3,5,2,7,4,9,8],
            heat_data=None, platform_counts={},
            global_ranking=[], earned_count=0,
    ...
    return render_template("stats.html",
        ...
        is_guest=False,
        week_activity=week_activity, heat_data=heat_data,
        platform_counts=platform_counts, global_ranking=global_ranking,
...
def ai_page():
    # Gość widzi sneak peek
    if not current_user.is_authenticated:
        return render_template("ai.html", is_guest=True)
    return render_template("ai.html", is_guest=False)
